...
export const NGX_ALERT_CONFIG = new InjectionToken<IAlertOptions>(
  'IAlertOptions',
);
...
export class AlertOptions implements IAlertOptions {
  public constructor(private config?: IAlertOptions) {
   ...
   *
   */
  useOverlay?: boolean = this.config?.useOverlay;
